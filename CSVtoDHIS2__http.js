...
alterState(state => {
  ...
  state.boolean = (value) => { //transform yes/no to boolean
    var val = (value.toString() !== undefined ? value.toLowerCase() : null);
    var newVal = (val !== null && val.trim() === "yes" ? true : false);
    return newVal;
  }
  state.attr = (id, value) => { //return attribute set with value
    return {
      attribute: id,
      value: value,
    };
  };
  state.dateConvert = (value) => { //convert date to YYYY-MM-DD format from MM/DD/YYYY
...
request({
  ...
  body: state => { return {
    ...
    enrollments: [{ //Create Enrollment #1
      program: 'NGtZYxE0zFM',
      ...
      enrollmentDate: state => {
        ...
        return state.dateConvert(date)(state)
      },
      incidentDate: state => {
        var date = dataValue('csvData.START DATE (MM/YY)')(state) // 4/1/18
        return state.dateConvert(date)(state)
      },
      events: [ //Create 2 Events
        { //Event #1
        ...
        { //Event #2
          ...
          dataValues: [{ //Col S
            ...
            { //Col X
              ...
              value: state => {
                var date = dataValue('csvData.VMyJ10uue3t')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col Y
            ...
            { //Col AC
              ...
              value: state => {
                var date = dataValue('csvData.gkFvMlQR7mD')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AD
            ...
            { //Col AG
              ...
              value: state => {
                var date = dataValue('csvData.Vl0MZ8bG3Mj')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AH
            ...
            { //Col AL
              ...
              value: state => {
                var date = dataValue('csvData.IXBQ9iyOsj7')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AM
            ...
            { //Col AP
              ...
              value: state => {
                var date = dataValue('csvData.wIora0v6L1w')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AQ
            ...
            { //Col AS
              ...
              value: state => {
                var date = dataValue('csvData.dtgxdpuv1gi')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AT
            ...
            { //Col AV
              ...
              value: state => {
                var date = dataValue('csvData.LmWgNlOgEmJ')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AW
            ...
            { //Col AY
              ...
              value: state => {
                var date = dataValue('csvData.l4pKaxmLOrW')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col AZ
            ...
            { //Col BB
              ...
              value: state => {
                var date = dataValue('csvData.Eh89gu65Xnd')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col BC
            ...
            { //Col BE
              ...
              value: state => {
                var date = dataValue('csvData.PrPEHhALnzl')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col BF
            ...
            { //Col BK
              ...
              value: state => {
                var date = dataValue('csvData.ylfCWUBbiZk')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col BL
            ...
            { //Col BN
              ...
              value: state => {
                var date = dataValue('csvData.VOgnzzSuYZX')(state)
                return state.dateConvert(date)(state)
              }
            },
            { //Col BO
            ...
            { //Col BQ
              ...
              value: state => {
                var date = dataValue('csvData.HN09RtK91MC')(state)
                return state.dateConvert(date)(state)
              }
            }
          ]
